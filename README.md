...
- The only repository policy is committed `.codex-safe.json` **Policy Schema v4** from Safe Core 4.16.0.
...
- Safe Core: `4.16.0` exact pin `786e3a3fc896e0e623af6fe63dbf814ddd09bad8`
