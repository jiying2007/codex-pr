...
- The only repository policy is committed `.codex-safe.json` **Policy Schema v4** from Safe Core 4.13.0.
...
- Safe Core: `4.13.0` exact pin `d95f67cc61ce66c16e2aa440829655919e906a75`
