...
- The only repository policy is committed `.codex-safe.json` **Policy Schema v4** from Safe Core 4.17.0.
...
- Safe Core: `4.17.0` exact pin `00403dd14877e978698c63d06f6dbdfe2ba9b8cc`
