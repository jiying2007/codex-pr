...
- The only repository policy is committed `.codex-safe.json` **Policy Schema v4** from Safe Core 4.15.0.
...
- Safe Core: `4.15.0` exact pin `e962826ee6556fd8ffa74ab1994bf43d62826f10`
