...
- The only repository policy is committed `.codex-safe.json` **Policy Schema v4** from Safe Core 4.10.0.
...
- Safe Core: `4.10.0` exact pin `57440a00030941020d5c3e9e01ced3c06062f42e`
